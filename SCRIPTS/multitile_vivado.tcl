...
cd $workdir 
#
create_project -force -part xc7k480tffv1156-1 prj_2  prj_2 
...
write_verilog post_layout_time.v -write_all_overrides -mode timesim -include_xilinx_libs -force
#
#place_design
#route_design
