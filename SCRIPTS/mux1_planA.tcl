...
set workdir {/import/home/tsung/CODE/SP7_planA/1-mux1/build-00000}
#
cd $workdir 
#
create_project -force -part xc6slx45tfgg484-3 mux1_prj  mux1_prj 
#
#set_param messaging.disableStorage 1
#link_design -part xc7s25csga324-1
#set prj_obj [get_projects mux1_prj]
#set_property XPM_LIBRARIES XPM_MEMORY [current_project] 
#
read_vhdl -library work $workdir/constants_pkg.vhd
#read_vhdl -library work $repo_dir/builders_repo/architectures/xilinx/spartan7/hdl/slice_mux-1.vhd
...
#
# save_project_as -force mux1_prj
#
# start_gui 
#
