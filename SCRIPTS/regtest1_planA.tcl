#
#
set repo_dir {/import/home/tsung/CODE/sp6_cift-internal}
set workdir $repo_dir/temp/all-slices-xc6slx45tfgg484-3-2021-05-19T17-41-25/1-regtest1/build-00000
#
cd $workdir 
#
...
read_vhdl -library work $repo_dir/builders_repo/architectures/xilinx/spartan6/hdl/slice_reg-1.vhd
read_vhdl -library work $workdir/plb.vhd
read_vhdl -library work $workdir/gold.vhd
read_vhdl -library work $repo_dir/builders_repo/architectures/xilinx/spartan6/hdl/regtest1_tpg.vhd
