...
set workdir $repo_dir/work/marchx_s10_bram_debug
...
set_global_assignment -name VHDL_FILE $cift_plugins/cift_xilinx/common/hdl/shared_clock_tdp_ram_simple.vhd 
set_global_assignment -name VERILOG_FILE $cift_plugins/cift_xilinx/common/hdl/dual_port_ram_ram_2port_2021_rksu5hq.v
set_global_assignment -name VHDL_FILE $cift_plugins/cift_xilinx/common/hdl/dual_port_ram_intel.vhd 
set_global_assignment -name VHDL_FILE $debug_dir/march_x.vhd
#set_global_assignment -name VHDL_FILE $cift_plugins/cift_builders/bram/single_port/hdl/march_x.vhd
set_global_assignment -name VHDL_FILE $workdir/sp2dp_converter.vhd
set_global_assignment -name VHDL_FILE $workdir/test_arch.vhd
set_global_assignment -name VHDL_FILE $debug_dir/ora.vhd
