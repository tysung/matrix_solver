...
foreach slice $slice_insts {
    ...
    set lut_insts [ get_cells -hier -filter {PRIMITIVE_GROUP==LUT} ]
...
route_design
#write_checkpoint /import/home/tsung/CODE/sp7_cift-internal/temp/RESULT_DIR/BUILD_TARG/build-00000/_ROUTED.dcp
#exit
