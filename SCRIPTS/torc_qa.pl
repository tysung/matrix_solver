...
my $qa_report = "${QA_HOME}/today/torc-internal/Build/Testing/Report.log";
my $exit_code;
my $latest_commit='';
my $flag_updated=1;
...
if( -e "${QA_HOME}/today/torc-internal" ) {
	chdir("${QA_HOME}/today/torc-internal");
...
system("rm -rf today/torc-internal");
system("mkdir today");
chdir("today");
...
#
my $qa_result = "${QA_HOME}/today/torc-internal/Build/Testing/Temporary/LastTest.log";
